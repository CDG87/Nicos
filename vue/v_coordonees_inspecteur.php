...
<?php if(isset($_POST['modif_suppr_inspec'])){ 
	$choix=0; ?>
	<form method="post" name="modif_suppr_inspecteur" action="index.php?uc=maj&action=coordonees_inspecteur">
		...
		<div class="form-group">
					...
					<br/><br/> <br/><br/>
					<table><tr><td>
					<input class="btn btn-default" type="submit" name="modifier_inspecteur" value="Modifier" /></td>
