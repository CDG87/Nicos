...
ALTER TABLE `participant`
  ADD CONSTRAINT `participant_ibfk_1` FOREIGN KEY (`NUM_STRUCTURE`) REFERENCES `test`.`strucure` (`NUM_STRUCTURE`);
...
ALTER TABLE `structure`
  ADD CONSTRAINT `fk_num_type_structure` FOREIGN KEY (`NUM_TYPE_STRUCTURE`) REFERENCES `type_structure` (`NUM_TYPE_STRUCTURE`);
