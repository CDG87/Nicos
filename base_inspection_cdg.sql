...
--
-- Client: localhost
-- Généré le: Lun 08 Janvier 2018 à 12:20
...
--
CREATE DATABASE IF NOT EXISTS `base_inspection_cdg` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `base_inspection_cdg`;
...
(7, 1, 35, '2017-11-15', NULL, NULL, NULL, NULL, 'Inspection', '2017-11-15');
...
INSERT INTO `batiment` (`NUM_BATIMENT`, `CODE_POLE`, `NOM_BATIMENT`, `code_Batiment`) VALUES
(1, 1, 'Mairie', NULL),
(2, 1, 'Siège', NULL),
(3, 2, 'Service technique', NULL),
(4, 2, 'Cimetière', NULL),
(5, 2, 'Station de chauffage', NULL),
(6, 2, 'Station de traitement des eaux', NULL),
(9, 4, 'Ecole maternelle', NULL),
(10, 4, 'Ecole primaire', NULL),
(11, 4, 'Restaurant scolaire', NULL),
(12, 4, 'Relais assistante maternelle', NULL),
(13, 4, 'Crèche', NULL),
(14, 5, 'Ecole de musique', NULL),
(15, 5, 'Centre de loisirs / Animation', NULL),
(16, 5, 'Office du tourisme', NULL),
(17, 5, 'Piscine', NULL),
(18, 5, 'Espace aquatique', NULL),
(19, 5, 'Bibliothèque', NULL),
(20, 6, 'Unité Alzheimer', NULL),
(21, 6, 'EPHAD (soins/chambres)', NULL),
(22, 6, 'Blanchisserie', NULL),
(32, 6, 'Cuisine centrale', NULL),
(33, 2, 'Lagune', NULL),
(34, 2, 'Réservoir eau potable', NULL),
(35, 1, 'Agence postale', NULL),
(36, 2, 'Déchetterie', NULL),
(37, 2, 'Station de transit', NULL),
(38, 2, 'Plate-forme déchets verts', NULL),
(40, 5, 'Complexe sportif', NULL),
(41, 5, 'Gymnase', NULL),
(42, 5, 'Camping / Village de vacances', NULL),
(43, 6, 'Salle polyvalente', NULL),
(44, 6, 'Salle des associations', NULL),
(45, 6, 'Logement social', NULL),
(46, 5, 'Opéra', NULL),
(47, 6, 'Foyer logement', NULL),
(48, 6, 'Portage à domicile', NULL),
(50, 7, 'Police municipale', NULL),
(51, 7, 'SDIS', NULL);

--
-- Déclencheurs `batiment`
--
DROP TRIGGER IF EXISTS `incre_batiment`;
DELIMITER //
CREATE TRIGGER `incre_batiment` BEFORE INSERT ON `batiment`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `controleur` (
  ...
  `LOGIN_CONTROLEUR` varchar(50) DEFAULT NULL,
  `MDP_CONTROLEUR` varchar(50) DEFAULT NULL,
  `ADMIN_CONTROLEUR` int(1) DEFAULT NULL,
...
INSERT INTO `controleur` (`NUM_CONTROLEUR`, `NOM_CONTROLEUR`, `PRENOM_CONTROLEUR`, `FONCTION_CONTROLEUR`, `AFFECTATION_CONTROLEUR`, `CENTRE_CONTROLEUR`, `ADRESSE_CONTROLEUR`, `TEL_FIXE_CONTROLEUR`, `TEL_MOBILE_CONTROLEUR`, `FAX_CONTROLEUR`, `EMAIL_CONTROLEUR`, `LOGIN_CONTROLEUR`, `MDP_CONTROLEUR`, `ADMIN_CONTROLEUR`) VALUES
(1, 'ROUSSY', 'Frédéric', 'Agent Chargé de la Fonction d’Inspection', 'Pôle SST / Service Prévention', 'Centre de Gestion de la Haute-Vienne', '55 rue de l’Ancienne École Normale d’Instituteurs \r\nBP 339 - 87009 Limoges Cedex ', '0555300863', '0630078852', '0555300864', 'frederic.roussy@cdg87.fr', 'admin', 'admin', 1),
(2, 'DERBALI', 'Elodie', 'Responsable du service Prévention des risques professionnels', 'Pôle SST / Service Prévention', 'Centre de Gestion de la Haute-Vienne', '55 rue de l’Ancienne École Normale d’Instituteurs \r\nBP 339 - 87009 Limoges Cedex ', '0555300854', '0689495877', '', 'elodie.derbali@cdg87.fr', 'prevention', 'nicos', 0),
(3, 'LAMANT', 'Didier', 'Préventeur', 'Pôle SST / Service Prévention', 'Centre de Gestion de la Haute-Vienne', '55 rue de l’Ancienne École Normale d’Instituteurs \r\nBP 339 - 87009 Limoges Cedex ', '0555300869', '', '', 'didier.lamant@cdg87.fr', 'prevention', 'nicos', 0);

--
-- Déclencheurs `controleur`
--
DROP TRIGGER IF EXISTS `incre_controleur`;
DELIMITER //
CREATE TRIGGER `incre_controleur` BEFORE INSERT ON `controleur`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `controle_critere` (
...
INSERT INTO `critere` (`NUM_CRITERE`, `NUM_THEME`, `NUM_SOUS_THEME`, `NUM_RESUME_ARTICLE`, `LIBELLE_CRITERE`) VALUES
...
--
DROP TRIGGER IF EXISTS `incre_critere`;
DELIMITER //
CREATE TRIGGER `incre_critere` BEFORE INSERT ON `critere`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `groupe_lieu` (
...
INSERT INTO `groupe_lieu` (`NUM_GROUPE_LIEU`, `LIBELLE_GROUPE_LIEU`) VALUES
(1, 'Atelier / Service (voirie...)'),
(2, 'Locaux sociaux / circulation'),
(3, 'Structure / Annexes (Mezz...)'),
(4, 'Local / Armoire'),
(5, 'Salle'),
(6, '@dministratif (bureau...)'),
(7, 'Eau / Assainissement / Déchets'),
(8, 'Engins / Véhicules (tracteur...)'),
(9, '# Structure globale #'),
(10, 'Restauration');
...
--
DROP TRIGGER IF EXISTS `incre_groupe_lieu`;
DELIMITER //
CREATE TRIGGER `incre_groupe_lieu` BEFORE INSERT ON `groupe_lieu`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `image_critere` (
...
(146, 195, 'mobilier_de_bureau.jpg'),
...
--
DROP TRIGGER IF EXISTS `incre_image_critere`;
DELIMITER //
CREATE TRIGGER `incre_image_critere` BEFORE INSERT ON `image_critere`
 FOR EACH ROW BEGIN
...
(7, 1, 1, 1, 1, 8, 94, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 95, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 96, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 97, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 98, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 99, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 100, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 101, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 102, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 103, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 8, 104, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 9, 106, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 9, 107, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 9, 108, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 9, 109, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 113, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 114, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 115, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 117, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 118, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 119, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 121, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 122, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 10, 123, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 11, 127, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 12, 129, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 12, 130, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 12, 132, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 12, 133, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 12, 134, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 12, 233, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 12, 248, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 13, 136, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 13, 138, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 14, 140, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 14, 141, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 14, 142, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 14, 143, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 14, 144, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 14, 244, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 14, 249, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 150, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 155, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 157, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 158, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 159, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 160, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 161, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 162, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 163, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 164, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 166, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 15, 239, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 16, 169, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 16, 170, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 16, 173, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 16, 175, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 16, 176, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 17, 178, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 17, 179, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 17, 180, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 18, 182, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 21, 193, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 21, 194, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 21, 195, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 21, 197, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 21, 237, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 22, 198, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 22, 199, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 201, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 206, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 207, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 209, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 211, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 212, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 213, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 215, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 216, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 222, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 223, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 245, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 23, 250, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 25, 251, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 26, 253, 'NC', 0, NULL, NULL),
(7, 1, 1, 1, 1, 26, 254, 'NC', 0, NULL, NULL);
...
INSERT INTO `lieu` (`NUM_LIEU`, `NUM_GROUPE_LIEU`, `NOM_LIEU`, `code_lieu`) VALUES
(1, 1, 'Atelier principal', NULL),
(2, 1, 'Service Espaces verts', NULL),
(3, 1, 'Service voirie', NULL),
(4, 1, 'Atelier soudage / meulage', NULL),
(5, 1, 'Atelier menuiserie', NULL),
(8, 1, 'Atelier peinture', NULL),
(10, 1, 'Atelier électricité', NULL),
(13, 1, 'Magasin / Stock', NULL),
(16, 2, 'Vestiaires', NULL),
(18, 2, 'Sanitaires', NULL),
(20, 2, 'Cuisine', NULL),
(21, 2, 'Salle de pause', NULL),
(22, 2, 'Salle de repos', NULL),
(26, 2, 'Chambres', NULL),
(30, 3, 'Toiture', NULL),
(31, 3, 'Mezzanine', NULL),
(32, 3, 'Estrade', NULL),
...
(34, 3, 'Sous sol', NULL),
(35, 3, 'Dortoir', NULL),
(38, 4, 'Armoire produits chimiques', NULL),
(39, 4, 'Armoire produits phytosanitaires', NULL),
(40, 4, 'Local produits chimiques', NULL),
(41, 4, 'Local produits inflammables', NULL),
(42, 4, 'Local produits d’entretien', NULL),
(43, 4, 'Local de stockage', NULL),
(44, 4, 'Local technique', NULL),
(45, 4, 'Local poubelles', NULL),
(46, 4, 'Local petit matériel', NULL),
(47, 4, 'Stock alimentaire', NULL),
(48, 4, 'Stockage consommables', NULL),
(49, 4, 'Local chaudière/ chaufferie', NULL),
(50, 5, 'Salle de repos', NULL),
(51, 5, 'Salle de pause', NULL),
(52, 5, 'Réfectoire', NULL),
(53, 5, 'Salle de réunion', NULL),
(54, 5, 'Salle du conseil', NULL),
(55, 5, 'Salle des mariages', NULL),
(56, 5, 'Salle de classe', NULL),
(57, 5, 'Salle de jeux', NULL),
(58, 5, 'Salle de loisirs', NULL),
(59, 5, 'Salle de motricité', NULL),
(60, 6, 'Accueil', NULL),
(66, 5, 'Salle de soins', NULL),
(69, 1, 'Illuminations de noël', NULL),
(71, 6, 'Secrétariat', NULL),
(72, 6, 'Bureau', NULL),
(73, 6, 'Bureau des élus', NULL),
(74, 6, 'Bureau Autorité Territoriale', NULL),
(75, 5, 'Salle principale', NULL),
(76, 6, 'Salle du conseil', NULL),
(77, 6, 'Salle des mariages', NULL),
(79, 8, 'Garage Véhicules', NULL),
(80, 9, 'Structure globale', NULL),
(81, 7, 'Bassin', NULL),
(82, 7, 'Puit', NULL),
(83, 7, 'Poste de relevage', NULL),
(84, 7, 'Réservoir', NULL),
(85, 7, 'Eco-point', NULL),
(86, 7, 'Laboratoire', NULL),
(87, 7, 'Quai', NULL),
(88, 7, 'Bas de quai', NULL),
(89, 8, 'Véhicules', NULL),
(90, 8, 'Engins', NULL),
(91, 8, 'Tracteur', NULL),
(92, 8, 'Tractopelle', NULL),
(93, 8, 'Tracteur épareuse', NULL),
(94, 8, 'Tondeuse autoportée', NULL),
(95, 8, 'Matériel porté', NULL),
(96, 8, 'Matériel tracté', NULL),
(97, 6, 'Archives', NULL),
(98, 8, 'Voiture', NULL),
(99, 8, 'Camion', NULL),
(100, 8, 'Fourgon / camionnette', NULL),
(102, 7, 'Haut de quai', NULL),
(103, 2, 'Escalier', NULL),
(104, 2, 'Couloir', NULL),
(106, 1, 'Service eau / assainissement', NULL),
(107, 10, 'Réception marchandises', NULL),
(108, 3, 'Vide-sanitaire', NULL),
(109, 10, 'Local poubelles', NULL),
(110, 10, 'Réserve', NULL),
(111, 10, 'Plonge', NULL),
(112, 10, 'Légumerie', NULL),
(113, 10, 'Salle à manger', NULL),
(114, 10, 'Cuisine', NULL),
(115, 10, 'Préparation chaude', NULL),
(116, 10, 'Préparation froide', NULL),
(118, 2, 'Voie d''accès', NULL);

--
-- Déclencheurs `lieu`
--
DROP TRIGGER IF EXISTS `incre_lieu`;
DELIMITER //
CREATE TRIGGER `incre_lieu` BEFORE INSERT ON `lieu`
 FOR EACH ROW BEGIN
...
(1, 1, 'L’Autorité Territoriale a désigné au moins un agent sur la mission d''Assistant de Prévention.', 1, NULL),
...
(107, 37, 'Il a été indiqué qu''aucun registre Santé et Sécurité au Travail n''a été ouvert.', 2, NULL),
...
--
DROP TRIGGER IF EXISTS `incre_observation`;
DELIMITER //
CREATE TRIGGER `incre_observation` BEFORE INSERT ON `observation`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `parametres_diffusion_rapport` (
...
CREATE TABLE IF NOT EXISTS `participant` (
  ...
  `NOM_FONCTION_PARTICIPANT` varchar(32) DEFAULT NULL,
...
--
DROP TRIGGER IF EXISTS `incre_participant`;
DELIMITER //
CREATE TRIGGER `incre_participant` BEFORE INSERT ON `participant`
 FOR EACH ROW BEGIN
...
INSERT INTO `pole` (`CODE_POLE`, `LIBELLE_POLE`) VALUES
(1, 'Administratif'),
(2, 'Technique'),
(4, 'Enfance'),
(5, 'Culture / Animation / Sport'),
(6, 'Santé / Social'),
(7, 'Police / Secours');
...
-- Déclencheurs `pole`
--
DROP TRIGGER IF EXISTS `incre_pole`;
DELIMITER //
CREATE TRIGGER `incre_pole` BEFORE INSERT ON `pole`
 FOR EACH ROW BEGIN
...
(7, 1, 1, 1, 1, 9, 109, 665),
(7, 1, 1, 1, 1, 23, 223, 623),
(7, 1, 1, 1, 1, 23, 223, 624),
(7, 1, 1, 1, 1, 23, 223, 834),
(7, 1, 1, 1, 1, 23, 245, 842),
(7, 1, 1, 1, 1, 23, 245, 843),
(7, 1, 1, 1, 1, 23, 245, 955),
(7, 1, 1, 1, 1, 23, 245, 956),
(7, 1, 1, 1, 1, 23, 250, 957),
(7, 1, 1, 1, 1, 23, 250, 958),
(7, 1, 1, 1, 1, 23, 250, 959),
(7, 1, 1, 1, 1, 25, 251, 960),
(7, 1, 1, 1, 1, 25, 251, 961),
(7, 1, 1, 1, 1, 25, 251, 963),
(7, 1, 1, 1, 1, 25, 251, 964),
(7, 1, 1, 1, 1, 25, 251, 965),
(7, 1, 1, 1, 1, 25, 251, 966),
(7, 1, 1, 1, 1, 26, 253, 1012),
(7, 1, 1, 1, 1, 26, 253, 1015),
(7, 1, 1, 1, 1, 26, 253, 1016),
(7, 1, 1, 1, 1, 26, 254, 1013),
(7, 1, 1, 1, 1, 26, 254, 1017),
(7, 1, 1, 1, 1, 26, 254, 1018);
...
--
DROP TRIGGER IF EXISTS `incre_preconisation`;
DELIMITER //
CREATE TRIGGER `incre_preconisation` BEFORE INSERT ON `preconisation`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `resume_article` (
  `NUM_RESUME_ARTICLE` smallint(6) NOT NULL,
...
(1, 'Art.108-3 de la Loi 84-53 du 26 janvier 1984:\r\nArt.4 du Décret 85-603 modifié (circulaire du 12 octobre 2012 pour application):\r\n...des assistants de prévention et, le cas échéant, des conseillers de prévention sont désignés par l’autorité territoriale sous l’autorité de laquelle ils exercent leurs fonctions. \r\nLes agents mentionnés au premier alinéa peuvent être mis à disposition, pour tout ou partie de leur temps par une commune, l’établissement public de coopération intercommunale dont est membre la commune, ou le centre de gestion, dans les conditions prévues à l’article 108-3 de la loi du 26 janvier 1984 susvisée.'),
(2, 'Art.4 du Décret 85-603 modifié du 10 juin 1985:  \r\n"Dans le champ de compétence du comité mentionné à l’article 37, des assistants de prévention et, le cas échéant, des conseillers de prévention sont désignés par l’autorité territoriale sous l’autorité de laquelle ils exercent leurs fonctions....."'),
...
--
DROP TRIGGER IF EXISTS `incre_resumer_article`;
DELIMITER //
CREATE TRIGGER `incre_resumer_article` BEFORE INSERT ON `resume_article`
 FOR EACH ROW BEGIN
...
INSERT INTO `sous_theme` (`NUM_SOUS_THEME`, `LIBELLE_SOUS_THEME`) VALUES
...
--
DROP TRIGGER IF EXISTS `incre_sous_theme`;
DELIMITER //
CREATE TRIGGER `incre_sous_theme` BEFORE INSERT ON `sous_theme`
 FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `structure` (
  ...
  KEY `I_FK_STRUCURE_TYPE_STRUCTURE` (`NUM_TYPE_STRUCTURE`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Déclencheurs `structure`
--
DROP TRIGGER IF EXISTS `incre_structure`;
DELIMITER //
CREATE TRIGGER `incre_structure` BEFORE INSERT ON `structure`
 FOR EACH ROW BEGIN
	DECLARE increstructure INTEGER;
	SET increstructure = (SELECT COALESCE(MAX(NUM_STRUCTURE), 0) + 1 FROM strucure);
	SET NEW.NUM_STRUCTURE = increstructure;
END
//
DELIMITER ;
...
-- Déclencheurs `theme`
--
DROP TRIGGER IF EXISTS `incre_theme`;
DELIMITER //
CREATE TRIGGER `incre_theme` BEFORE INSERT ON `theme`
 FOR EACH ROW BEGIN
...
--
-- Déclencheurs `type_structure`
--
DROP TRIGGER IF EXISTS `incre_type_structure`;
DELIMITER //
CREATE TRIGGER `incre_type_structure` BEFORE INSERT ON `type_structure`
 FOR EACH ROW BEGIN
	DECLARE incretypestructure INTEGER;
	SET incretypestructure = (SELECT COALESCE(MAX(NUM_TYPE_STRUCTURE), 0) + 1 FROM type_structure);
	SET NEW.NUM_TYPE_STRUCTURE = incretypestructure;
END
//
DELIMITER ;
...
ALTER TABLE `audit`
  ...
  ADD CONSTRAINT `audit_ibfk_2` FOREIGN KEY (`NUM_STRUCTURE`) REFERENCES `structure` (`NUM_STRUCTURE`);
...
--
ALTER TABLE `critere`
  ADD CONSTRAINT `critere_ibfk_1` FOREIGN KEY (`NUM_THEME`) REFERENCES `theme` (`NUM_THEME`),
  ADD CONSTRAINT `critere_ibfk_2` FOREIGN KEY (`NUM_SOUS_THEME`) REFERENCES `sous_theme` (`NUM_SOUS_THEME`);
...
--
-- Contraintes pour la table `image_critere`
--
ALTER TABLE `image_critere`
  ADD CONSTRAINT `image_critere_ibfk_1` FOREIGN KEY (`NUM_CRITERE`) REFERENCES `critere` (`NUM_CRITERE`);
...
--
ALTER TABLE `lieu`
  ADD CONSTRAINT `lieu_ibfk_1` FOREIGN KEY (`NUM_GROUPE_LIEU`) REFERENCES `groupe_lieu` (`NUM_GROUPE_LIEU`);

--
-- Contraintes pour la table `observation`
--
ALTER TABLE `observation`
  ADD CONSTRAINT `observation_ibfk_1` FOREIGN KEY (`NUM_CRITERE`) REFERENCES `critere` (`NUM_CRITERE`);

--
-- Contraintes pour la table `participant`
--
ALTER TABLE `participant`
  ADD CONSTRAINT `participant_ibfk_1` FOREIGN KEY (`NUM_STRUCTURE`) REFERENCES `structure` (`NUM_STRUCTURE`);
...
ALTER TABLE `preconisation`
  ADD CONSTRAINT `preconisation_ibfk_1` FOREIGN KEY (`NUM_CRITERE`) REFERENCES `critere` (`NUM_CRITERE`);

--
-- Contraintes pour la table `se_trouver`
--
ALTER TABLE `se_trouver`
  ADD CONSTRAINT `se_trouver_ibfk_1` FOREIGN KEY (`NUM_BATIMENT`) REFERENCES `batiment` (`NUM_BATIMENT`),
  ADD CONSTRAINT `se_trouver_ibfk_2` FOREIGN KEY (`NUM_LIEU`) REFERENCES `lieu` (`NUM_LIEU`);

--
-- Contraintes pour la table `structure`
--
ALTER TABLE `structure`
  ADD CONSTRAINT `structure_ibfk_1` FOREIGN KEY (`NUM_TYPE_STRUCTURE`) REFERENCES `type_structure` (`NUM_TYPE_STRUCTURE`);
