...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 06 Février 2018 à 09:36
...
(7, 3, 118, '2018-02-01', NULL, NULL, NULL, NULL, 'Inspection', '2018-02-01'),
(8, 2, 139, '2018-02-01', NULL, NULL, NULL, NULL, 'Inspection', '2018-02-01');
...
(1, 7, 'NC', 1, NULL, 'CCNES_PN-MDC_2018-01-15 (4).JPG');
...
(7, 1, 1, 6, 60, 8, 93, 'NC', 0, NULL, NULL),
(7, 1, 1, 6, 60, 8, 97, 'NC', 1, NULL, 'Aixe-sur-Vienne_2016-11-25 (3).JPG');
...
--
ALTER TABLE `audit`
  MODIFY `NUM_AUDIT` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `participant`
  MODIFY `NUM_PARTICIPANT` smallint(6) NOT NULL AUTO_INCREMENT;
--
