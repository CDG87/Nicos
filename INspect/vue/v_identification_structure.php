	...
	<div class="col-xs-12 col-sm-6 col-md-8">
			...
			<?php
				if($numTypeStructureSelection != "") { ?>
					...
					<div class="col-sm-4">
                        <input required class="form-control" required="required" type="text" placeholder="Rechercher..." id="nom_structure" name="nom_structure" value="<?php if(isset($_POST['generer_adr'])){ echo $_POST['nom_structure'];}else{ echo $_SESSION['nom_structure'];} ?>" /> 
					</div>
					<?php
