...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 14 Février 2018 à 08:51
...
(1, 1, 'Mairie', NULL, 'fa-fort-awesome'),
(2, 1, 'Siège', NULL, 'fa-building'),
(3, 2, 'Service technique', NULL, 'fa-wrench'),
(4, 2, 'Cimetière', NULL, 'fa-inbox'),
(5, 2, 'Station de chauffage', NULL, 'fa-fire'),
(6, 2, 'Station de traitement des eaux', NULL, 'fa-stumbleupon'),
(9, 4, 'Ecole maternelle', NULL, NULL),
(10, 4, 'Ecole primaire', NULL, NULL),
(11, 4, 'Restaurant scolaire', NULL, 'fa-utensil-spoon'),
...
(34, 2, 'Réservoir eau potable', NULL, 'fa-tint'),
(35, 1, 'Agence postale', NULL, 'fa-envelope-square'),
(36, 2, 'Déchetterie', NULL, 'fa-trash'),
(37, 2, 'Station de transit', NULL, 'fa-exchange'),
(38, 2, 'Plate-forme déchets verts', NULL, 'fa-pagelines'),
...
(4, 1, 1, 4, 'Formation Initiale et continue de l’AP', 'fa-weixin'),
...
(9, 1, 2, 9, 'Formation Initiale et continue du CP', 'fa-weixin'),
...
(17, 1, 4, 17, 'Existence CT ou CHS-CT', 'fa-users'),
(18, 1, 4, 18, 'Formation des membres du CHS-CT', 'fa-weixin'),
...
(44, 2, 7, 44, 'Habilitations électriques', 'fa-id-card'),
...
(81, 5, NULL, 81, 'Formation à l’utilisation des EPI', 'fa-weixin'),
...
(102, 8, 10, 102, 'Local de repos', 'fa-coffee'),
...
(113, 10, 12, 113, 'Moyens d’extinction de première intervention', 'fa-fire-extinguisher'),
...
(122, 10, 14, 122, 'Système alarme sonore', 'fa-bell'),
...
(137, 13, NULL, 137, 'Formation et information du personnel', 'fa-weixin'),
(138, 13, NULL, 138, 'Limitations des ports de charges', NULL),
(139, 14, 15, 139, 'Permis', NULL),
(140, 14, 15, 140, 'Formation FIMO/FCO', 'fa-weixin'),
...
(145, 14, 16, 145, 'Formation au balisage', 'fa-weixin'),
...
(160, 15, 19, 160, 'Formation tondeuse autoportée', 'fa-weixin'),
...
(183, 18, NULL, 183, 'Formation - Information', 'fa-weixin'),
...
(203, 23, 21, 203, 'Formation', 'fa-weixin'),
...
(212, 23, 24, 212, 'Formation certifiée', 'fa-weixin'),
...
(219, 23, 26, 219, 'Formation spécifique en piscine', 'fa-weixin'),
(220, 23, 26, 220, 'Travail isolé', NULL),
(221, 23, 27, 221, 'Formation spécifique en menuiserie', 'fa-weixin'),
...
(239, 15, 18, 239, 'Formation à la conduite', 'fa-weixin'),
(240, 10, 12, 240, 'Vannes "police"', NULL),
(241, 23, 28, 241, 'Formation', 'fa-weixin'),
(242, 23, 28, 242, 'Habilitation et renouvellement', 'fa-id-card'),
...
(2, 2, 'CCAS de BELLAC', '14 place de la République', 'BELLAC', 87300, NULL, 'ccasbellac@wanadoo.fr'),
...
(111, 1, 'Mairie de La Roche-l\'Abeille', '10 place du 11 novembre 1918', 'LA ROCHE L’ABEILLE', 87800, NULL, 'larochelabeille.mairie@wanadoo.fr'),
...
(226, 1, 'Commune des SALLES LAVAUGUYON', 'Marie', 'LES SALLES LAVAUGUYON', 87440, '0555003068', 'mairiedessalleslavauguyon@wanadoo.fr'),
...
(244, 2, 'OPERA DE LIMOGES', 'Boulevard Carnot', 'LIMOGES', 87000, '0555459500', 'francoise-trapinaud@ville-limoges.fr'),
(245, 2, 'PETR du Pays MONTS et BARRAGES', 'Le Château', 'BUJALEUF', 87460, NULL, 'accueil@monts-et-barrages-en-limousin.fr '),
(246, 2, 'PNR PERIGORD LIMOUSIN', 'Maison du Parc La Barde', 'LA COQUILLE', 24450, NULL, 'info@pnrpl.com '),
...
--
ALTER TABLE `audit`
  MODIFY `NUM_AUDIT` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `observation`
  MODIFY `NUM_OBSERVATION` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1025;
--
-- AUTO_INCREMENT pour la table `participant`
--
ALTER TABLE `participant`
  MODIFY `NUM_PARTICIPANT` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `pole`
--
ALTER TABLE `pole`
  MODIFY `CODE_POLE` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
