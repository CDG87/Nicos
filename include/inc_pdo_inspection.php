...
/*----EXPORT------------------------------------------------------------------------------------------------------*/	
	...
	*/
	...
	/*
	* Export table par table (ou plusieurs tables a la fois)
	
		$mysqlUserName      = "root";
		$mysqlPassword      = "";
		$mysqlHostName      = "localhost";
		$DbName             = "base_inspection_cdg";
		$backup_name        = "tables.sql";
		$tables             = array("critere","image_critere","observation");
		$pdo->Export_Database($mysqlHostName,$mysqlUserName,$mysqlPassword,$DbName,  $tables=true, $backup_name=false );
	*/
   //or add 5th parameter(array) of specific tables:    array("mytable1","mytable2","mytable3") for multiple tables


    function Export_Database($host,$user,$pass,$name,  $tables=true, $backup_name=false )
    {
